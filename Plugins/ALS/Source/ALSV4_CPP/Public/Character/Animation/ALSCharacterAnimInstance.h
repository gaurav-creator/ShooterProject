...
class ALSV4_CPP_API UALSCharacterAnimInstance : public UAnimInstance, public IRecoil
{
	GENERATED_BODY()
...
public:
	UFUNCTION()
	virtual void IF_Recoil_Implementation(float Strength, float Delay, float TimeBeforeStart) override;
