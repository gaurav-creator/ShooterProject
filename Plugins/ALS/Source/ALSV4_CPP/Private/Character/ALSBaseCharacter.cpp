...
bool AALSBaseCharacter::IsWeaponEquipped() const
{
	return CombatComponent && CombatComponent->EquippedWeapon;
}

AWeapon* AALSBaseCharacter::GetEquippedWeapon() const
{
...
/*FVector AALSBaseCharacter::GetFirstPersonCameraTargetADS()
{
	...
	{
		return CombatComponent->EquippedWeapon->GetWeaponMesh()->GetSocketLocation(NAME_ADS);
	}
